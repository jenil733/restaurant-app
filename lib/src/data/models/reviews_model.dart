...
class ReviewsDataModel {
  ...
  factory ReviewsDataModel.fromJson(Map<String, dynamic> json) {
    ...
    final rawList = json['reviews'] ?? json['data'] ?? json['feedbacks'];
    if (rawList is List) {
      items = rawList
          .whereType<Map>()
    ...
    final rawTotal = json['total_feedbacks'] ?? json['total_reviews'] ?? json['total'];
    if (rawTotal is int) {
      total = rawTotal;
...
class ReviewsResponseModel {
  ...
  factory ReviewsResponseModel.fromJson(Map<String, dynamic> json) {
    ...
    ReviewsDataModel? dataModel;
    final rawData = json['data'];
    if (rawData is Map) {
      dataModel = ReviewsDataModel.fromJson(Map<String, dynamic>.from(rawData));
      isSuccess = true;
    } else if (rawData is List) {
      dataModel = ReviewsDataModel.fromJson({'reviews': rawData});
      isSuccess = true;
    }
